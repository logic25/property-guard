...
const ExpandableApplicationRow = ({ application, index, note, onNoteChange }: ExpandableApplicationRowProps) => {
  ...
  const getBISJobUrl = (jobNumber: string) => {
    return `https://a810-bisweb.nyc.gov/bisweb/JobsQueryByNumberServlet?passjoession=&pasession=&requestid=&passession=&pasession=&requestid=1&requestid=&requestid=&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&requestid=0&jobsession=&joession=&joession=&joession=&joession=&joession=&joession=&joession=&jobnumber=${jobNumber}`;
  };
